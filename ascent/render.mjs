...
//
//   node ascent/render.mjs          cues + frames + mux  -> ascent/out/the-long-way-up.mp4
//   node ascent/render.mjs --cues   only write ascent/out/cues.json
//
...
const url = `http://127.0.0.1:${server.address().port}/ascent/index.html?capture`;
